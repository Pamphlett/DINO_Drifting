...
DST_ROOT="/cpfs/pengyu/DINO-Foresight/logs/dino_foresight_lowres_opendv_drift_noallgather"
...
echo "Starting ${NGPU}-GPU drifting training on OpenDV (no cross-rank negative gather)..."
